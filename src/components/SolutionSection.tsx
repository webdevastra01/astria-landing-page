  ...
  const processSteps = [
    {
      ...
      title: "Analyze",
      description:
        "We assess your financial risks, income sources, assets, and family situation to understand your unique protection needs.",
    },
    {
      number: "02",
      title: "Compare",
      description:
        "We evaluate policies from multiple insurers to find the best coverage options, rates, and terms for your specific situation.",
    },
    {
      number: "03",
      title: "Structure",
      description:
        "We design a comprehensive protection plan that coordinates all your coverage, eliminating gaps and redundancies.",
    },
  ];
      ...
      <div className="container">
        ...
        <div className="section-header solution-header">
          ...
          <p className="section-description">
            Astria Insurance Solutions focuses on protection planning, not just
            selling policies.
          </p>
        </div>
          ...
          <div className="solution-content">
            <div className="solution-intro">
              <p className="solution-text">
                We analyze your financial risks, evaluate multiple insurers, and
                structure a coverage plan that protects your{" "}
                <strong>income, assets, family, and business</strong>.
              </p>
              <p className="solution-closing">
                With Astria, you gain{" "}
                <span className="highlight-success">clarity</span>,{" "}
                <span className="highlight-success">confidence</span>, and{" "}
            ...
            <button
              className="btn btn-primary btn-lg solution-cta"
              onClick={() => {
                setIsModalOpen(true);
              }}
            >
